...
bool checkgrayscale(SDL_Surface *s)
{
    ...
    {
        Uint32 colorKey;
        SDL_GetColorKey(s, &colorKey);
        if(s->format->palette->ncolors != 256 || !colorKey) return false;
...
SDL_Surface *fixsurfaceformat(SDL_Surface *s)
{
    ...
    {
        case 1:
            if(!checkgrayscale(s)) return colorKey ? forcergbasurface(s) : forcergbsurface(s);
            break;
        case 3:
