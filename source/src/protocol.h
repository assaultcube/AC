...
#define MAXMODDOWNLOADSIZE \
  1024000  // hard cap on the filesize of downloaded mod packages - to keep
           // stuff reasonable
#define MAXFILESINADZIP \
  21  // max number of files extracted from a zip by autodownload
...
enum {
  ...
  GMMASK__FLAGS = GMMASK_CTF | GMMASK_HUNTTHEFLAG | GMMASK_KEEPTHEFLAG |
                  GMMASK_TEAMKEEPTHEFLAG,
  GMMASK__BOT = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS |
                GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY |
                GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL |
                GMMASK_BOTTEAMSURVIVOR,
  GMMASK__MP = GMMASK_TEAMDEATHMATCH | GMMASK_COOPEDIT | GMMASK_DEATHMATCH |
               GMMASK_SURVIVOR | GMMASK_TEAMSURVIVOR | GMMASK_CTF |
               GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING |
               GMMASK_ONESHOTONEKILL | GMMASK_TEAMONESHOTONEKILL |
               GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG |
               GMMASK_KEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS,
  GMMASK__MPNOCOOP = GMMASK__MP & ~GMMASK_COOPEDIT,
  GMMASK__TEAM = GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL |
                 GMMASK_BOTTEAMSURVIVOR | GMMASK_TEAMDEATHMATCH |
                 GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_TEAMONESHOTONEKILL |
                 GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_TEAMPF |
                 GMMASK_TEAMLSS,
  GMMASK__TEAMSPAWN = GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL |
                      GMMASK_BOTTEAMSURVIVOR | GMMASK_TEAMDEATHMATCH |
                      GMMASK_TEAMSURVIVOR | GMMASK_CTF |
                      GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG |
                      GMMASK_TEAMPF | GMMASK_TEAMLSS,
  GMMASK__FFA = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS |
                GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY |
                GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR |
                GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING |
                GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG,
  GMMASK__FFASPAWN = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS |
                     GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY |
                     GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR |
                     GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING |
                     GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG |
                     GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG
};
...
#define FTXT__MAPINFO_LICENSE \
  (FTXT_NOWHITE | FTXT_NOCOLOR | FTXT_TOLOWER | FTXT_MAPNAME)
#define FTXT__MAPINFO_COMMENT \
  (FTXT_NOWHITE | FTXT_NOCOLOR | FTXT_ALLOWBLANKS | FTXT_TABTOBLANK)
#define FTXT__MAPNAME (FTXT_NOCOLOR | FTXT_MAPNAME | FTXT_TOLOWER)
#define FTXT__MDLATTR                                                 \
  (FTXT_NOWHITE | FTXT_ALLOWBLANKS | FTXT_TABTOBLANK | FTXT_NOCOLOR | \
   FTXT_SAFECS)
