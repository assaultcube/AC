...
enum
{
    ...
    GMODE_22,                           // 22 claimed in parkour-branch
    GMODE_23,                           // 23 claimed in parkour-branch
    GMODE_RAGEDEATHMATCH,               // 24
    GMODE_RAGETEAMDEATHMATCH,           // 25
    GMODE_PACKDEATHMATCH,               // 26
    GMODE_PACKTEAMDEATHMATCH,           // 27
    GMODE_EXTREMEDEATHMATCH,            // 28
    GMODE_EXTREMETEAMDEATHMATCH,        // 29
    GMODE_BATTLETEAMDEATHMATCH,         // 30
    GMODE_NUM
};
...
enum
{
    ...
    // […] 22 & 23 left out
    GMMASK_RAGEDEATHMATCH        = 1 << GMODE_RAGEDEATHMATCH,               // 24
    GMMASK_RAGETEAMDEATHMATCH    = 1 << GMODE_RAGETEAMDEATHMATCH,           // 25
    GMMASK_PACKDEATHMATCH        = 1 << GMODE_PACKDEATHMATCH,               // 26
    GMMASK_PACKTEAMDEATHMATCH    = 1 << GMODE_PACKTEAMDEATHMATCH,           // 27
    GMMASK_EXTREMEDEATHMATCH     = 1 << GMODE_EXTREMEDEATHMATCH,            // 28
    GMMASK_EXTREMETEAMDEATHMATCH = 1 << GMODE_EXTREMETEAMDEATHMATCH,        // 29
    GMMASK_BATTLETEAMDEATHMATCH  = 1 << GMODE_BATTLETEAMDEATHMATCH,         // 30
    ...
    GMMASK__MP        = GMMASK_TEAMDEATHMATCH | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR | GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING
                      | GMMASK_ONESHOTONEKILL | GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_KEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS | GMMASK_RAGEDEATHMATCH | GMMASK_PACKDEATHMATCH | GMMASK_EXTREMEDEATHMATCH | GMMASK_RAGETEAMDEATHMATCH | GMMASK_PACKTEAMDEATHMATCH | GMMASK_EXTREMETEAMDEATHMATCH | GMMASK_BATTLETEAMDEATHMATCH,
    ...
    GMMASK__TEAM      = GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL | GMMASK_BOTTEAMSURVIVOR | GMMASK_TEAMDEATHMATCH | GMMASK_TEAMSURVIVOR | GMMASK_CTF
                      | GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS | GMMASK_RAGETEAMDEATHMATCH | GMMASK_PACKTEAMDEATHMATCH | GMMASK_EXTREMETEAMDEATHMATCH | GMMASK_BATTLETEAMDEATHMATCH,
    GMMASK__TEAMSPAWN = GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL | GMMASK_BOTTEAMSURVIVOR | GMMASK_TEAMDEATHMATCH | GMMASK_TEAMSURVIVOR | GMMASK_CTF
                      | GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS | GMMASK_RAGETEAMDEATHMATCH | GMMASK_PACKTEAMDEATHMATCH | GMMASK_EXTREMETEAMDEATHMATCH | GMMASK_BATTLETEAMDEATHMATCH,
    GMMASK__FFA       = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                      | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG | GMMASK_RAGEDEATHMATCH | GMMASK_PACKDEATHMATCH | GMMASK_EXTREMEDEATHMATCH,
    GMMASK__FFASPAWN  = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                      | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_RAGEDEATHMATCH | GMMASK_PACKDEATHMATCH | GMMASK_EXTREMEDEATHMATCH 
};
...
#define m_rage        (gamemode==24 || gamemode==25)
#define m_pack        (gamemode==26 || gamemode==27)
#define m_extreme     (gamemode==28 || gamemode==29)
#define m_battle      (gamemode==30)
