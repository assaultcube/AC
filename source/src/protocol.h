...
enum
{
    ...
    GMODE_NORMPARKOUR,                  // 22
    GMODE_FREEPARKOUR,                  // 23
    GMODE_NUM
};
...
enum
{
    ...
    GMMASK_NORMPARKOUR          = 1 << GMODE_NORMPARKOUR,                  // 22
    GMMASK_FREEPARKOUR          = 1 << GMODE_FREEPARKOUR,                  // 23
    GMMASK__ALL        = (1 << GMODE_NUM) - 1,
    GMMASK__PARKOUR    = GMMASK_NORMPARKOUR | GMMASK_FREEPARKOUR,
    GMMASK__PARKORCOOP = GMMASK__PARKOUR | GMMASK_COOPEDIT,
    ...
    GMMASK__MP         = GMMASK_TEAMDEATHMATCH | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR | GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING
                       | GMMASK_ONESHOTONEKILL | GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_KEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS | GMMASK_NORMPARKOUR | GMMASK_FREEPARKOUR, // leaving PARKOUR masks in .. but really: only when needed
    ...
    GMMASK__FFA        = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                       | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG, // not until actually needed: | GMMASK_NORMPARKOUR | GMMASK_FREEPARKOUR, // this /may/ be required
    GMMASK__FFASPAWN   = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                       | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG // not until actually needed: | GMMASK_NORMPARKOUR | GMMASK_FREEPARKOUR // this should only be used in gmode_possible()
};
...
#define m_park        (gamemode==22) || (gamemode==23)
