...
#define PROTOCOL_VERSION 1301           // bump when protocol changes (use negative numbers for mods!)
...
enum
{
    SV_SERVINFO = 0, SV_SERVINFO_RESPONSE, SV_SERVINFO_CONTD, SV_WELCOME, SV_INITCLIENT, SV_POS, SV_POSC, SV_POSC2, SV_POSC3, SV_POSC4, SV_POSN,
...
enum { VOTEE_DISABLED = 0, VOTEE_CUR, VOTEE_MUL, VOTEE_MAX, VOTEE_AREA, VOTEE_PERMISSION, VOTEE_INVALID, VOTEE_WEAK, VOTEE_NEXT, VOTEE_SHUFFLETEAMS, VOTEE_PAUSE, VOTEE_NUM };
enum { MM_OPEN = 0, MM_PRIVATE, MM_MATCH, MM_NUM }; enum { MM_MASK = 0x03 };
enum { DC_DEMO = 0, DC_NUM };
enum { DT_INIT = 0, DT_PROGRESS, DT_FINISH, DT_QUIRK, DT_ERROR, DT_NUM };
...
enum
{
    ...
    GMMASK_PARKOUR              = 1 << GMODE_PARKOUR,
    GMMASK_GEMA                 = 1 << GMODE_GEMA,
    GMMASK__ALL        = (1 << GMODE_NUM) - 1,
    GMMASK__KARP       = GMMASK_PARKOUR | GMMASK_GEMA,
    GMMASK__KARPORCOOP = GMMASK_PARKOUR | GMMASK_GEMA | GMMASK_COOPEDIT,
    GMMASK__PARKORCOOP = GMMASK_PARKOUR | GMMASK_COOPEDIT,
    GMMASK__GEMAORCOOP = GMMASK_GEMA | GMMASK_COOPEDIT,
    GMMASK__FLAGS      = GMMASK_CTF | GMMASK_HUNTTHEFLAG | GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG,
    GMMASK__FLAGENTS   = GMMASK_CTF | GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_GEMA,
    ...
    GMMASK__MP         = GMMASK_TEAMDEATHMATCH | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR | GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING
                       | GMMASK_ONESHOTONEKILL | GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_KEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS, // only add if required:  | GMMASK_PARKOUR | GMMASK_GEMA
    ...
    GMMASK__FFA        = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                       | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG,  // only add if required:  | GMMASK_PARKOUR | GMMASK_GEMA
    GMMASK__FFASPAWN   = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                       | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG  // only add if required:  | GMMASK_PARKOUR | GMMASK_GEMA // ATM this is only being used in gmode_possible()
};
...
#define m_park        (gamemode==22)
#define m_gema        (gamemode==23)
#define m_karp        (gamemode==22 || gamemode==23)
...
#define m_flags_      (m_ctf || m_htf || m_ktf || m_gema) // trailing underscore is required to prevent name clash on FreeBSD systems
...
#define FTXT__SERVERINFOLINE (FTXT_ALLOWTAB | FTXT_CROPWHITE_TRAIL)
