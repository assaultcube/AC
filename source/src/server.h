...
guninfo guns[NUMGUNS] =
{
    ...
    { "shotgun",    S_SHOTGUN,    S_RSHOTGUN, 2400,   800,    1,      0,   0,  1,   35,   7,    9,  9,    10, 140,    140,    125,  1,      false },   // CAUTION dmg only sane for server!
    { "subgun",     S_SUBGUN,     S_RSUBGUN,  1650,   80,     16,     0,   0, 45,   15,   30,   1,  2,    4,  30,     50,     188,  1,      true  },
    { "sniper",     S_SNIPER,     S_RSNIPER,  1950,   1500,   80,     0,   0, 50,   50,   5,    4,  4,    10, 85,     85,     100,  1,      false },   // 2011may22:ft: dmg 82->80, spread 50
    { "assault",    S_ASSAULT,    S_RASSAULT, 2000,   120,    24,     0,   0, 18,   40,   15,   0,  2,    2,  22,     55,     115,  1,      true  },
