...
itemstat ammostats[NUMGUNS] =
{
    ...
    {20, 80, 100,  S_ITEMAMMO  },   // pistol : CHANGED since 1.1.0.4 2010nov19
...
guninfo guns[NUMGUNS] =
{
    ...
    { "pistol",     S_PISTOL,     S_RPISTOL,  1400,   160,    18,     0,   0, 55,   10,   10,   6,  5,    6,  35,     58,     125,  1,      false },   // CHANGED : magsize
    ...
    { "sniper",     S_SNIPER,     S_RSNIPER,  1950,   1500,   83,     0,   0, 50,   50,   5,    4,  4,    10, 85,     85,     100,  1,      false },   // CHANGED : damage, spread
