...
#define MAPVERSION \
    9 // default map format version to be written (bump if map format changes,
      // see worldio.cpp)
...
#define MAXHHITS \
    50000 // was 6000, which denied my fav. maps - jamz, 2012-06-12; 15000
          // denies sane map too - lucas
#define MINFF 2500
