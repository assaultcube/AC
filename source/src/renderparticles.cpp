...
static struct parttype { int type; float r, g, b; int gr, tex; float sz; } parttypes[MAXPARTYPES] =
{
    ...
    { PT_BLOOD,       0.5f, 0.0f, 0.0f,  1,  4, 0.30f }, // red:    blood spats
    { PT_PART,        1.0f, 0.1f, 0.1f,  0,  1, 0.20f }, // red:    demotrack
    { PT_FIREBALL,    1.0f, 0.5f, 0.5f,  0,  2, 7.00f }, // explosion fireball
    { PT_SHOTLINE,    1.0f, 1.0f, 0.7f,  0, -1, 0.00f }, // yellow: shotline
    { PT_BULLETHOLE,  1.0f, 1.0f, 1.0f,  0,  3, 0.30f }, // hole decal

    { PT_STAIN,       0.5f, 0.0f, 0.0f,  0,  4, 0.60f }, // red:    blood stain
    { PT_DECAL,       1.0f, 1.0f, 1.0f,  0,  5, 1.50f }, // scorch decal
    { PT_HUDFLASH,    1.0f, 1.0f, 1.0f,  0,  6, 0.70f }, // hudgun muzzle flash
    { PT_FLASH,       1.0f, 1.0f, 1.0f,  0,  6, 0.70f }, // muzzle flash
    ...
    { PT_PART,        1.0f, 0.5f, 0.2f, 20,  0, 0.08f }, // edit mode ent type :   carrot/trigger : orange
