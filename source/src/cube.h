...
#include "command.h"
 ...
 enum
 {
   ...
   TOUCH_GAME_CORNER_TOP_LEFT_1 = 10011,
   TOUCH_GAME_CORNER_TOP_LEFT_2 = 10012,
   TOUCH_GAME_CORNER_BOTTOM_LEFT = 10013,
   TOUCH_GAME_CORNER_BOTTOM_RIGHT = 10014,
   ...
   TOUCH_GAME_RIGHTSIDE_0 = 10030,
   TOUCH_GAME_RIGHTSIDE_1 = 10031,
   TOUCH_GAME_RIGHTSIDE_2 = 10032,
   TOUCH_GAME_RIGHTSIDE_3 = 10033,
   TOUCH_GAME_RIGHTSIDE_4 = 10034,
   TOUCH_GAME_RIGHTSIDE_DOUBLETAP = 10035,
