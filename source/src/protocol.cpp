...
const char *modefullnames[] =
{
    ...
    "gamemode #22", "gamemode #23",
    "rage deathmatch", "rage team deathmatch", "pack deathmatch", "pack team deathmatch", "extreme deathmatch", "extreme team deathmatch", "battle deathmatch"
};
...
const char *modeacronymnames[] =
{
    ...
    "-mode-22-", "-mode-23-",
    "RAGE", "TRAGE", "PACK", "TPACK", "XDM", "TXDM", "BATTLE"
};
