...
struct consolebuffer
{
    ...
    void addline(const char *sf, int millis)        // add a line to the console buffer
    {
        cline cl;
        cl.line = conlines.length()>100 ? conlines.pop().line : newstringbuf("");   // constrain the buffer size
