...
{    
    ...
    if(!installtex(2,  path(newstring("packages/misc/newchars.png")), xs, ys) ||
       ...
       !installtex(1,  path(newstring("packages/crosshairs/default.png")), xs, ys)) fatal("could not find core textures (hint: run cube from the parent of the bin directory)");
