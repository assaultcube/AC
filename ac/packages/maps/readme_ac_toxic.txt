...
|			|
|	Who Am I	|
|			| Try my site for awesome AC stuff:
|	  ????		|
...
Mapname: ac_toxic
Version: 1.0
First released: Tuesday, 25th December, 2007.
Last updated: Thursday, 15th May, 2008.

These files are have been created for ac_toxic:
	1) ac_toxic.cgz
	2) ac_toxic.cfg
	3) readme_ac_toxic.txt
...
thousands of dollars from) when RVSF got jealous and deployed themselves 
...
History
-------
ac_toxic was RandumIdiot's first leap towards high-quality map editing. 
High quality and nice layout. It was released on the 25th of December, 
as a Christmas present to the AssaultCube community.

ac_toxic started out as an idea to create a half indoor, half outdoor 
map for ac that contained special mapmodels to allow spectating. 
This map was planned to be called ri_spectate.

Some time later I discovered that spectate mode in AssaultCube v1.0 was 
going to become reality and that version 1.0 was not too far away from 
release. This meant that the idea was scrapped. The map lost all of its 
spectator features, but its layout stayed somewhat the same.

Then over several months, this map was transformed into ri_toxic.

Later, makkE told me he likes this map and that it can be included in the 
offical AssaultCube distribution. So, the map has been given a config 
file and makkE made an awesome toxic drum mapmodel for me to use in the 
map.. mega thanks for that makkE. 
